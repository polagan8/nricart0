...
- Source formatted with Prettier; only browser-safe public project URL and publishable key included.
...
- Supabase migration and anonymous-function permission fix are applied remotely; preview catalog is seeded and public client configuration is wired. Actual email delivery, signup confirmation, login, recovery, RLS against hosted PostgREST and authenticated admin UI still require connected-project checks.
